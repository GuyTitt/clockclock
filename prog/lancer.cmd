...
rem md html\Hebreu4.0\html
rem copy package\html\Hebreu4.0\html\style.css html\Hebreu4.0\html\style.css
...
echo ============================================================
echo  npx http-server html -p 3500 --cors -c-1 -o "/index.html"
echo.
